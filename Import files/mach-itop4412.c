...
static uint32_t smdk4x12_keymap[] __initdata = {
	...
	/*
	 KEY(0, 0, KEY_VOLUMEUP), KEY(0, 1, KEY_VOLUMEDOWN), KEY(0, 2, KEY_F1), KEY(0, 3, KEY_MENU), KEY(0, 4, KEY_F2),KEY(0, 5, KEY_CAMERA) */
};
...
//add by mch for ME3630 20170723
#ifdef CONFIG_LTE_CTL
struct platform_device s3c_device_lte_ctl = {
        .name   = "me3630",
        .id             = -1,
};
#endif
